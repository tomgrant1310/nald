...
(function($){
    ...
    jQuery(document).ready(function(){
        ...
        for(var i=1;i<=3;i++){
            data["pr_"+i+"_image_slide_preview"] = [];
            $("#pr_"+i+"_image_slide_preview").find("li.sortable-item").each(function(){
                data["pr_"+i+"_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["pr_"+i+"_image_slide_preview"].length <=1 ) {
                $("#pr_"+i+"_image_slide_preview").find(".remove").hide();
            }
            data["pr_"+i+"_ct_text_preview"] = [];
            $("#pr_"+i+"_ct_text_preview").find("li.sortable-item").each(function(){
                data["pr_"+i+"_ct_text_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["pr_"+i+"_ct_text_preview"].length <=1 ) {
                $("#pr_"+i+"_ct_text_preview").find(".remove").hide();
            }

        }
        data["hd_vd_ct_2_icon_preview"] = [];
        $("#hd_vd_ct_2_icon_preview").find("li.sortable-item").each(function(){
            data["hd_vd_ct_2_icon_preview"].push(parseInt($(this).attr("data-num"),10));
        });
        if(data["hd_vd_ct_2_icon_preview"].length <=1 ) {
            $("#hd_vd_ct_2_icon_preview").find(".remove").hide();
        }
        ...
        if(data["hd_image_slide_preview"].length <=1 ) {
            $("#hd_image_slide_preview").find(".remove").hide();
        }
        data["hd_slide_ct_text_icon_preview"] = [];
        $("#hd_slide_ct_text_icon_preview").find("li.sortable-item").each(function(){
            data["hd_slide_ct_text_icon_preview"].push(parseInt($(this).attr("data-num"),10));
        });
        if(data["hd_slide_ct_text_icon_preview"].length <=1 ) {
            $("#hd_slide_ct_text_icon_preview").find(".remove").hide();
        }
        data["hd_slide_ct_text_preview"] = [];
        $("#hd_slide_ct_text_preview").find("li.sortable-item").each(function(){
            data["hd_slide_ct_text_preview"].push(parseInt($(this).attr("data-num"),10));
        });
        if(data["hd_slide_ct_text_preview"].length <=1 ) {
            $("#hd_slide_ct_text_preview").find(".remove").hide();
        }
        data["nf_image_slide_preview"] = [];
        $("#nf_image_slide_preview").find("li.sortable-item").each(function(){
            data["nf_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
        });
        if(data["nf_image_slide_preview"].length <=1 ) {
            $("#nf_image_slide_preview").find(".remove").hide();
        }
        data["ft_image_slide_preview"] = [];
        $("#ft_image_slide_preview").find("li.sortable-item").each(function(){
            data["ft_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
        });
        if(data["ft_image_slide_preview"].length <=1 ) {
            $("#ft_image_slide_preview").find(".remove").hide();
        }
        data["ft_sc_preview"] = [];
        $("#ft_sc_preview").find("li.sortable-item").each(function(){
            data["ft_sc_preview"].push(parseInt($(this).attr("data-num"),10));
        });
        if(data["ft_sc_preview"].length <=1 ) {
            $("#ft_sc_preview").find(".remove").hide();
        }
